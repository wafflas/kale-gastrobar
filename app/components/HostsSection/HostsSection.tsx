        ...
        <div className="w-full max-w-3xl md:max-w-5xl lg:max-w-6xl mx-auto pt-8 md:pt-16 px-0 sm:px-4 z-20">
          <div className="relative overflow-hidden rounded-3xl border border-darkbrown/15 bg-gradient-to-br from-cream/60 via-cream/45 to-cream/20 backdrop-blur-xl px-5 py-8 sm:p-10 md:p-12 flex flex-col items-center justify-center text-center gap-7 sm:gap-8 md:flex-row md:items-center md:justify-between md:gap-8 lg:gap-12 shadow-[0_20px_50px_rgba(93,62,50,0.08)] transition-all duration-500 hover:shadow-[0_25px_60px_rgba(93,62,50,0.12)]">
            ...
            <div className="flex flex-col items-center md:flex-1 md:min-w-0 z-10">
              ...
              <p className="font-vollkorn text-darkbrown/70 text-xs sm:text-sm italic tracking-wide max-w-md text-center">
                {t("hosts.tagline")}
              </p>
              ...
              <Button
                variant="primary"
                size="sm"
                className="hidden md:inline-flex rounded-full px-8 py-3.5 shadow-[0_4px_20px_rgba(93,62,50,0.12)] hover:shadow-[0_6px_25px_rgba(93,62,50,0.22)] transform hover:-translate-y-0.5 hover:scale-[1.03] transition-all duration-300 tracking-[0.16em] mt-6"
            ...
            <Button
              variant="primary"
              size="sm"
              className="md:hidden rounded-full px-8 py-3.5 shadow-[0_4px_20px_rgba(93,62,50,0.12)] hover:shadow-[0_6px_25px_rgba(93,62,50,0.22)] transform hover:-translate-y-0.5 hover:scale-[1.03] transition-all duration-300 tracking-[0.16em]"
              onClick={openReservation}
            >
              {t("hosts.reserve_now")}
            </Button>
