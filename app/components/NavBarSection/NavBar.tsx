...
export default function NavBar() {
  ...
  return (
    ...
    >
      <div
        ref={slideRef}
        className="absolute bottom-0 left-0 right-0 w-full bg-darkbrown text-cream flex flex-col px-8 py-4 md:px-12 md:py-6 overflow-y-auto pointer-events-auto min-h-0"
        style={{ height: 0 }}
      >
